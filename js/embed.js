...
function sskadmin(e) {
    var ssk = '';
    if (e.user_id == 6379936145165255426) {
        if (checkMobile()) {
            ssk = '<span class="ua"><span class="sskadmin">博主大哥</span></span><br><br>';
        } else {
            ssk = '<span class="ua"><span class="sskadmin">博主大哥</span></span>';
        }
    } else {
        if (checkMobile()) {
            ssk = '<br><br>';
